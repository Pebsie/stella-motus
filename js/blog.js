...
"<post><himg>img/placeholder-cargo.jpg</himg><title>S4X Scanner TESTED</title><body>The folks at Scan'em Technologies were kind enough to send us their new S4X scanner. So how does it fare against the world-renowned S3X series? We investigate...</body></post></blog>";
...
for (var i = 0; i<y.length;i++) {
  for (var z = 0; z<y[i].childNodes.length;z++) {
    if (y[i].childNodes[z].nodeName == "himg") {
      ...
      t += "<p>" + y[i].childNodes[z].childNodes[0].nodeValue + "</p><hr>";
    }
  }
}
